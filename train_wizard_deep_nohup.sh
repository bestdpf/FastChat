...
nohup python -m torch.distributed.run --nproc_per_node=4 --master_port=20012 fastchat/train/train_mem.py \
    --model_name_or_path ../Meta-Llama-3.1-8B  \
    --data_path ../chatfine/total_gpt_full_combine_20240906.json\
    --bf16 True \
    --tf32 True \
    --output_dir fastchat-vicuna-3-8b-20240906 \
    --num_train_epochs 3 \
